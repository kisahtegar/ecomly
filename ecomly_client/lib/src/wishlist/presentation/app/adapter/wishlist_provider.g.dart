...
abstract class _$UserWishlist
  ...
  WishlistState build([GlobalKey<State<StatefulWidget>>? familyKey]);
}
...
class UserWishlistFamily extends Family<WishlistState> {
  ...
  /// See also [UserWishlist].
  UserWishlistProvider call([GlobalKey<State<StatefulWidget>>? familyKey]) {
    return UserWishlistProvider(familyKey);
  }
...
class UserWishlistProvider
  ...
  /// See also [UserWishlist].
  UserWishlistProvider([GlobalKey<State<StatefulWidget>>? familyKey])
    : this._internal(
  ...
  @override
  WishlistState runNotifierBuild(covariant UserWishlist notifier) {
