...
import 'package:ecomly_client/src/auth/presentation/widgets/otp_fields.dart';
import 'package:ecomly_client/src/auth/presentation/widgets/otp_timer.dart';
...
class _VerifyOTPScreenState extends ConsumerState<VerifyOTPScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Verify OTP', style: TextStyles.headingSemiBold),
