...
String _$productAdapterHash() => r'31400b35e48f2bd811b2efe201a9727db211b816';
...
abstract class _$ProductAdapter
  ...
  ProductState build([GlobalKey<State<StatefulWidget>>? familyKey]);
}
...
class ProductAdapterFamily extends Family<ProductState> {
  ...
  /// See also [ProductAdapter].
  ProductAdapterProvider call([GlobalKey<State<StatefulWidget>>? familyKey]) {
    return ProductAdapterProvider(familyKey);
  }
...
class ProductAdapterProvider
  ...
  /// See also [ProductAdapter].
  ProductAdapterProvider([GlobalKey<State<StatefulWidget>>? familyKey])
    : this._internal(
  ...
  @override
  ProductState runNotifierBuild(covariant ProductAdapter notifier) {
