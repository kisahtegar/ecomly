...
abstract class _$GenderAgeCategoryNotifier
  ...
  GenderAgeCategory build([GlobalKey<State<StatefulWidget>>? familyKey]);
}
...
class GenderAgeCategoryNotifierFamily extends Family<GenderAgeCategory> {
  ...
  GenderAgeCategoryNotifierProvider call([
    ...
    return GenderAgeCategoryNotifierProvider(familyKey);
  }
...
/// See also [GenderAgeCategoryNotifier].
class GenderAgeCategoryNotifierProvider
    extends
        AutoDisposeNotifierProviderImpl<
          GenderAgeCategoryNotifier,
          GenderAgeCategory
        > {
  /// See also [GenderAgeCategoryNotifier].
...
class _GenderAgeCategoryNotifierProviderElement
    extends
        AutoDisposeNotifierProviderElement<
          ...
          GenderAgeCategory
        >
    with GenderAgeCategoryNotifierRef {
