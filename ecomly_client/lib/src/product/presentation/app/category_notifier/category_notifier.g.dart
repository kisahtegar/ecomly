...
abstract class _$CategoryNotifier
  ...
  ProductCategory build([GlobalKey<State<StatefulWidget>>? familyKey]);
}
...
class CategoryNotifierFamily extends Family<ProductCategory> {
  ...
  /// See also [CategoryNotifier].
  CategoryNotifierProvider call([GlobalKey<State<StatefulWidget>>? familyKey]) {
    return CategoryNotifierProvider(familyKey);
  }
...
class CategoryNotifierProvider
  ...
  /// See also [CategoryNotifier].
  CategoryNotifierProvider([GlobalKey<State<StatefulWidget>>? familyKey])
    : this._internal(
  ...
  @override
  ProductCategory runNotifierBuild(covariant CategoryNotifier notifier) {
